        ...
        <div className="p-6 md:p-8 bg-[#edf3f5] rounded-md">
          ...
          <form className="space-y-4 font-albert">
            ...
            <div>
              ...
              <Input id="email" className="mt-2 border-gray-300 bg-white" type="email" placeholder="Enter your mail" required />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Select>
                  <SelectTrigger className="mt-2 font-albert border-gray-300 text-gray-600">
                    <SelectValue placeholder="Select youy visa type" className="placeholder-albert"/>
                    {/* <span className="font-albert text-gray-700">
                      <SelectValue placeholder="Select Your Program" />
                    </span> */}
                  </SelectTrigger>
